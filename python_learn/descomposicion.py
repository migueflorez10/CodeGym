...
# ** El objetivo del script es descomponer el número en unidades, decenas, centenas, miles... tal que por 
# ejemplo si se introduce el número:**
...
if (len(sys.argv) == 2):
    ...
    if numero < 0 or numero > 9999:
        ...
        print('Ej: descomposicion.py [0-9999]')
    else: 
        cadena = str(numero)
        longitud = len(cadena)
